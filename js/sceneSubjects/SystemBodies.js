...
import { PlanetOrbitController } from "/js/modules/OrbitController.js";
import { LabelController } from "/js/modules/LabelController.js";
import { OrbitSubject } from "/js/sceneSubjects/OrbitSubject.js";

export function StarBody(scene, renderer, params_in=null) {
    ...
    // Orbit Line
    if (this.params.horizons) {
        this.orbitLine = new OrbitSubject(scene, this)
    }
